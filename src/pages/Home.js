    ...
    return (<>{loading?<Spinner />:
        <Container  className="home__container">
            <Alert variant="success">
                ...
                <p>Save the code that is reusable to you but never want to remember just like a password.</p>
                <p>
                ...
                <hr />
                <center><b>Copyright &copy; 2021 Recode Snippet - Kadum Komut</b></center>
            </Alert>
        </Container>}</>
    )
}
